export default function Team() {
    return (
        <>
            ...
            <div className="grid grid-cols-4  h-fit  md:gap-x-10 gap-y-4 md:px-24 md:py-15  px-2 py-10 bg-gray-800  md:gap-x-5  ">
                <ImageBox
                    imgurl={"/director.png"}
                    name="Prem Lama"
                    position="Director"
...
function ImageBox({ imgurl, name, position }) {
    return (
        <div className="text-start ">
            <img src={`${imgurl}`} alt="" className="md:w-64 md:h-80 w-56 h-72" />
