    ...
    return (
        <div className="carousel carousel-center w-full p-4 space-x-4 bg-white rounded-box mx-20">
            <div className="carousel-item">
                <img src="/team1.jpeg" className="rounded-box w-72 h-fit" />
            </div>
            <div className="carousel-item">
                <img src="/team2.jpeg" className="rounded-box w-72 h-fit" />
            </div>
            <div className="carousel-item">
                <img src="/team3.jpeg" className="rounded-box w-72 h-fit" />
            </div>
            <div className="carousel-item">
                <img src="/team1.jpeg" className="rounded-box w-72 h-fit" />
            </div>
